...
namespace Catalog.API.Data
{
    ...
    {
        public static void Seed(IMongoCollection<Product> productsCollection)
        {
            var existProducts = productsCollection.Find(p => true).Any();
            if (!existProducts)
            {
                productsCollection.InsertMany(GetPreConfigProducts());
            }
        }
